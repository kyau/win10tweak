...
CreateShortcut "Development\Fork" "$($env:UserProfile)\AppData\Local\Fork\Fork.exe" "github"
CreateShortcut "Media\MPV" "$($env:ProgramData)\chocolatey\lib\mpv.install\tools\mpv.exe" "mpv"
CreateShortcut "Utilities\7-Zip File Manager" "$($env:ProgramFiles)\7zip\7zFM.exe" "file-roller"
