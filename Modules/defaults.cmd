...
%~dp0..\Tools\DefenderControl.exe /D
:: Network
...
PowerShell -Command "$Blacklist = Get-WindowsPackage -Online | Where-Object {$_.PackageName -Match '^(OpenSSH-Client|Microsoft-Windows-Hello-Face|Microsoft-Windows-InternetExplorer|Microsoft-Windows-MediaPlayer|Microsoft-Windows-QuickAssist|Microsoft-Windows-TabletPCMath).*'} | Select-Object PackageName,PackageState | Sort-Object PackageName; foreach ($app in $Blacklist) { Remove-WindowsPackage -Online -NoRestart -PackageName $app.PackageName -ErrorAction SilentlyContinue | Out-Null }" >nul
:: Remove 3D Paint
...
PowerShell -Command "Disable-WindowsOptionalFeature -Online -FeatureName 'WindowsMediaPlayer' -NoRestart -WarningAction SilentlyContinue | Out-Null"
...
::SETX PATH "%PATH%;%%ProgramData%%\chocolatey" /M
...
%SystemRoot%\System32\powercfg.exe /setactive e9a42b02-d5df-448d-aa00-03f14749eb61 >nul
